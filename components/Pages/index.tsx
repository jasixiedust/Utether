...
const Page: PageEl = (props, state, refresh, getProps) => {
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh"}}>
      <br-x />
      <Window title={"قیمت لحظه ای تتر ( دلار )"} style={{ minHeight: 180, margin: 10, width: "calc(100% - 20px)",display:"flex",alignItems:"center",flexDirection:"column" }}>


      <br-x/>


      <div style = {{width: "50%" , height: 35 , backgroundColor: "#61d3e2" , borderRadius: "10"
          , textAlign:"center" 
        }}>   
            <br-x/>
            قیمت لحظه ای : 
